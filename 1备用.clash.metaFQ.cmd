...
rem  关键路径自检
rem =========================
if not exist "%~dp0clash.meta" (
  echo [错误] 未找到目录：%~dp0clash.meta
...
if not exist "%~dp0clash.meta\clash.meta-windows-386.exe" (
  echo [错误] 未找到：%~dp0clash.meta\clash.meta-windows-386.exe
...
title Clash.Meta 一键启动

echo 是否执行IP更新？IP更新从云端更新IP配置以解决封锁问题！
echo 按7跳过，按1选择ip1更新，若ip1不好用再按2选ip2更新，如果更新后都用不了，请发邮件到freeman105@gmail.com进行反馈！
